...
class Agent_DQN(Agent):
    def __init__(self, env, args):
        ...
        self.batch_size = 32
        self.replace_target_iteration = 2000
        ...
        if args.test_dqn:
            ...
            self.epsilon = 0.05           
            saver.restore(self.sess, "Model/model_dqn.ckpt")
    ...
    def _build_net(self):
        ...
        with tf.variable_scope('eval_net'):
            ...
            with tf.variable_scope('fc1'):
                W_fc1 = self._weight_variables([11*11*64, 512], name = 'w_fc1')
                b_fc1 = self._bias_variables([512], name = 'b_fc1')
            ...
            with tf.variable_scope('output'):
                W_fc2 = self._weight_variables([512, 4], name = 'w_fc2')
                b_fc2 = self._bias_variables([4], name = 'b_fc2')
        ...
        with tf.variable_scope('target_net'):
            ...
            with tf.variable_scope('output'):
                W_fc2 = self._weight_variables([512, 4], name = 'w_fc2')
                b_fc2 = self._bias_variables([4], name = 'b_fc2')
                self.q_next = tf.matmul(h_fc1, W_fc2) + b_fc2        
    ...
    def train(self):
        ...
        for i_episode in range(MAX_EPOCH):
                ...
                if i_episode % 100 == 0 and i_episode != 0:
                    ...
                    for i in range(10):
                        ...
                        while not done :
                            ...
                            test_reward += reward
                        test_avgreward.append(test_reward)
                        print('epoch : ', i, '\ttesting reward: ', test_reward)
                    print('avg_reward : ', np.mean(test_avgreward))
                    break
                    '''
                else:
                    ...
                    if ep_t % self.replace_target_iteration == 0:
                        ...
                        save_path = saver.save(self.sess, "Model_dqn4/model_dqn4_2000.ckpt")
            ...
            np.save('dqn_reward_2000.npy', np.array(rewards))
